...
Python readiness audit는 검토 가능한 `paideia-public-release-readiness/v1` 보고서를 씁니다. 이 검사는 소스 저장소 메타데이터와 CI gate만 확인하며, 네트워크 호출, 서브프로세스 실행, 비공개 생성 런타임 상태 검사를 수행하지 않습니다.
