...
def _commands() -> list[dict[str, str]]:
    purposes = {
        ...
        "build-openclaw-onboarding-menu": "Write a first-run provider/model and chat-channel menu for OpenClaw-style Paideia onboarding.",
        ...
        "build-openclaw-native-onboarding-runbook": "Write an OpenClaw-native onboard/model/gateway/channel/agent-add runbook for a runtime bundle.",
        "doctor-openclaw-employment-runtime": "Doctor a hired talent's selected OpenClaw provider/model and chat channel runtime path.",
        "build-openclaw-live-smoke-plan": "Write a no-secret operator sequence for offline context, Gateway, live LLM, and OpenClaw channel smoke tests.",
        "audit-openclaw-goal-readiness": "Audit one hired talent's OpenClaw-style LLM, chat, WebChat, installed runtime, and smoke-test readiness.",
        ...
        "doctor-openclaw-installed-runtime": "Read-only doctor for the locally installed OpenClaw CLI, config, Gateway, model, and channel status with redaction.",
