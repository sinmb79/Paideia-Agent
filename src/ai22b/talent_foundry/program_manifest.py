...
def _commands() -> list[dict[str, str]]:
    purposes = {
        ...
        "run-onboarding-next-action": "Run an allowlisted local onboarding launch-plan action, such as onboarding doctor or first offline chat, only after explicit owner approval.",
