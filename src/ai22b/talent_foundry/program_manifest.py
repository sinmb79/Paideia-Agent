...
def _commands() -> list[dict[str, str]]:
    purposes = {
        ...
        "build-agent-program": "Build a 22B Paideia program manifest from a hired talent record.",
        ...
        "run-agent-program-chat": "Chat through the 22B Paideia education center/runtime using local growth records and reasoning kibo.",
...
def build_public_program_manifest(run_dir: Path, *, output_path: Path | None = None) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "program_name": "22B Paideia",
        "program_name_ko": "22B 파이데이아",
