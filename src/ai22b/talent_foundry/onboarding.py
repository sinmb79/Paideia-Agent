...
def run_agent_onboarding(
    *,
    ...
    artifacts = {
        ...
        "agent_id_card_payload": training_run["artifacts"].get("agent_id_card_payload"),
        "agent_identity_envelope": training_run["artifacts"].get("agent_identity_envelope"),
        "agent_identity_verification": training_run["artifacts"].get("agent_identity_verification"),
        "agent_warrent_registration_request": training_run["artifacts"].get("agent_warrent_registration_request"),
