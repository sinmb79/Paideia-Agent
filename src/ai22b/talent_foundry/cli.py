...
def _build_parser() -> argparse.ArgumentParser:
    ...
    run_hired_agent_command.add_argument("--llm-mode", choices=["offline", "live"], default="offline")
    run_hired_agent_command.add_argument("--live-llm", action="store_true")
    run_hired_agent_command.add_argument("--llm-model")
    ...
    run_hired_workspace_agent_command.add_argument("--llm-mode", choices=["offline", "live"], default="offline")
    run_hired_workspace_agent_command.add_argument("--live-llm", action="store_true")
    run_hired_workspace_agent_command.add_argument("--llm-model")
    ...
    run_hired_agent_job_command.add_argument("--llm-mode", choices=["offline", "live"], default="offline")
    run_hired_agent_job_command.add_argument("--live-llm", action="store_true")
    run_hired_agent_job_command.add_argument("--llm-model")
    ...
    run_hired_dataflow_job_command.add_argument("--llm-mode", choices=["offline", "live"], default="offline")
    run_hired_dataflow_job_command.add_argument("--live-llm", action="store_true")
    run_hired_dataflow_job_command.add_argument("--llm-model")
    ...
    run_hired_agent_job_cycle_command.add_argument("--llm-mode", choices=["offline", "live"], default="offline")
    run_hired_agent_job_cycle_command.add_argument("--live-llm", action="store_true")
    run_hired_agent_job_cycle_command.add_argument("--llm-model")
