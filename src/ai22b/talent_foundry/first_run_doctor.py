...
def _chat_smoke_summary(report: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "runtime_status_card_schema": details.get("runtime_status_card_schema"),
        "runtime_status_card_status": details.get("runtime_status_card_status"),
        "runtime_status_card_fallback_used": details.get("runtime_status_card_fallback_used"),
