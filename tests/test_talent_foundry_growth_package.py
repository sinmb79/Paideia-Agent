...
class PaideiaGrowthPackageTests(unittest.TestCase):
    def test_graduate_package_and_same_sky_cli_use_growth_profile(self) -> None:
        ...
        self.assertTrue(release_audit["checkpoints"]["fail_closed_runtime_contract"]["passed"])
        self.assertTrue(release_audit["checkpoints"]["workspace_execution_proof_safety"]["passed"])
        ...
        fail_closed_details = release_audit["checkpoints"]["fail_closed_runtime_contract"]["details"]
        ...
        proof_details = release_audit["checkpoints"]["workspace_execution_proof_safety"]["details"]
        self.assertEqual(proof_details["schema"], "paideia-workspace-execution-proof-safety/v1")
        self.assertEqual(proof_details["mode"], "role_model_runtime_minimum")
        self.assertEqual(proof_details["required_minimum"], 1)
        self.assertGreaterEqual(proof_details["proof_count"], 1)
