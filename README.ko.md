...
## 최근 보완: 2026-06-12 ~ 2026-06-14

어제와 오늘 보완한 핵심은 Paideia의 “폐쇄성”을 단순 보안 정책이 아니라 인간형 학습 구조로 명확히 고정한 것입니다.

- **6하 원칙 목표추진 모드**: agent run, hired chat, program chat, 온보딩, 설치형 프로그램에 모두 `task_pursuit_plan`을 남깁니다. 지시를 받으면 누가/무엇을/언제/어디서/왜/어떻게를 먼저 정리하고, 필요한 자료만 조사하고, 작업/개발/검증/수정을 반복하여 완료 또는 명확한 차단 조건까지 진행합니다.
...
- **답하기 전에 계획하고 끝까지 추진합니다.** 중요한 지시는 6하 원칙 목표추진 계획으로 먼저 구조화하고, 필요한 조사, 작업, 검증, 수정, 완료 조건을 따라 진행합니다.
